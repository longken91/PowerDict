package com.ltao.pdict.parser.babylon;

public class BglConstants {

	public static final String[] Bgl_language = { "English", "French",
			"Italian", "Spanish", "Dutch", "Portuguese", "German", "Russian",
			"Japanese", "Traditional Chinese", "Simplified Chinese", "Greek",
